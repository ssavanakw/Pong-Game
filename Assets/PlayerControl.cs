...
public class PlayerControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Jika pemain menekan tombol ke atas, beri kecepatan positif kekomponen y(ke atas).
        if (Input.GetKey(upButton))
        {
            velocity.y = speed;
        }
        // Jika pemain menekan tombol ke bawah, beri kecepatan negatif kekomponen y(ke bawah).
        ...
        // Jika posisi raket melewati batas atas (yBoundary), kembalikan kebatas atas tersebut.
        if (position.y > yBoundary)
        {
            position.y = yBoundary;
        }
        // Jika posisi raket melewati batas bawah (-yBoundary), kembalikan kebatas atas tersebut.
    ...
    // Menaikkan skor sebanyak 10 ketika mengenai merah
    public void RedScore()
    {
        score += 10;
    }
    // Menaikkan skor sebanyak 8 ketika mengenai biru
    public void BlueScore()
    {
        score += 8;
    }
    // Menaikkan skor sebanyak 5 ketika mengenai yellow
